...
- 🧵 Темы форумов и автосинхронизация КД под слоумод канала
- 🎨 Цветные кнопки (Bot API 9.4) и неактивные индикаторы (10.3)
- Настройка интервала рассылки (общий и на чат)
...
- ⚙️ Настройки: журнал отправок в отдельный чат, отчёты, вкл/выкл всех чатов
